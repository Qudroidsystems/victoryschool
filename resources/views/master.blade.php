...
<head>
    ...
    <!-- Font-awesome -->
    <link href="{{ asset('html/assets2/all-study/assets/css/font-awesome.min.css')}}" rel="stylesheet">

    <!-- Flaticon -->
    <link href="{{ asset('html/assets2/all-study/assets/flaticon/flaticon.css')}}" rel="stylesheet">

    <!-- lightcase -->
    <link href="{{ asset('html/assets2/all-study/assets/css/lightcase.css')}}" rel="stylesheet">

    <!-- Swiper -->
    <link href="{{ asset('html/assets2/all-study/assets/css/swiper.min.css')}}" rel="stylesheet">

    <!-- quick-view -->
    <link href="{{ asset('html/assets2/all-study/assets/css/quick-view.css')}}" rel="stylesheet">

    <!-- nstSlider -->
    <link href="{{ asset('html/assets2/all-study/assets/css/jquery.nstSlider.css')}}" rel="stylesheet">

    <!-- flexslider -->
    <link href="{{ asset('html/assets2/all-study/assets/css/flexslider.css')}}" rel="stylesheet">

    <!-- Style -->
    <link href="{{ asset('html/assets2/all-study/assets/css/style.css')}}" rel="stylesheet">
  		...
  		<div class="header-middle">
  			<div class="container">
  				<div class="row">
	  				...
	  				<div class="col-md-4 col-sm-4 col-xs-4">
	  					<a href="/" ><img src="{{ asset('html/assets2/all-study/images/victory/vcc-logo.png')}}" alt="logo image" width="60px" hieght="60px"></a>
	  				</div>
	  				{{-- <div class="col-md-4 col-sm-4 col-xs-4">
...
Conveniently transition awesome theme customer.</p>
  				...
  				<div class="row">
  					<div class="col-md-3 col-sm-6 col-xs-12">
  						<div class="footer-item">
  							<div class="title"><a href="index-10.html"><img src="images/logo_02.png" alt="logo" class="img-responsive"></a></div>
    ...
    <!-- Bootstrap -->
    <script src="{{ asset('html/assets2/all-study/assets/js/bootstrap.min.js')}}"></script>

    <!-- counterup -->
    <script src="{{ asset('html/assets2/all-study/assets/js/jquery.waypoints.min.js')}}"></script>
    <script src="{{ asset('html/assets2/all-study/assets/js/jquery.counterup.min.js')}}"></script>

    <!-- Isotope -->
    <script src="{{ asset('html/assets2/all-study/assets/js/isotope.min.js')}}"></script>

    <!-- lightcase -->
    <script src="{{ asset('html/assets2/all-study/assets/js/lightcase.js')}}"></script>

    <!-- Swiper -->
    <script src="{{ asset('html/assets2/all-study/assets/js/swiper.jquery.min.js')}}"></script>

    <!--progress-->
    <script src="{{ asset('html/assets2/all-study/assets/js/circle-progress.min.js')}}"></script>

    <!--velocity-->
    <script src="{{ asset('html/assets2/all-study/assets/js/velocity.min.js')}}"></script>

    <!--quick-view-->
    <script src="{{ asset('html/assets2/all-study/assets/js/quick-view.js')}}"></script>

    <!--nstSlider-->
    <script src="{{ asset('html/assets2/all-study/assets/js/jquery.nstSlider.js')}}"></script>

    <!--flexslider-->
    <script src="{{ asset('html/assets2/all-study/assets/js/flexslider-min.js')}}"></script>

    <!--easing-->
    <script src="{{ asset('html/assets2/all-study/assets/js/jquery.easing.min.js')}}"></script>


    <!-- custom -->
    <script src="{{ asset('html/assets2/all-study/assets/js/custom.js')}}"></script>
