...
@section('content')
  	...
  	<!-- About Section -->
  	<section id="about" class="about padding-120" data-aos="fade-up">
  		<div class="container">
  			<h3 data-aos="fade-down" data-aos-delay="100">Welcome to Victory Comprehensive College, Ondo</h3>
  			<h4 data-aos="fade-down" data-aos-delay="200">A Centre of Learning, Character, and Excellence</h4>
  			<p data-aos="fade-up" data-aos-delay="300">Victory Comprehensive College (VCC), Ondo, is a co-educational secondary school located in the heart of Ondo town, Ondo State, Nigeria. Established with a vision to raise generations of disciplined, intellectually sound, and morally upright leaders, we have consistently produced outstanding students who excel in national examinations (WAEC, NECO, JAMB) and beyond.</p>
  			<p data-aos="fade-up" data-aos-delay="400">Our school offers a balanced curriculum that integrates academic rigor, spiritual growth, vocational skills, and extracurricular activities. With qualified and dedicated teachers, modern learning facilities, and a safe environment, we nurture each child to reach their fullest potential.</p>
  			<ul>
  				<li><a href="#contact" class="button-default" data-aos="zoom-in" data-aos-delay="500">Enroll Your Child Today</a></li>
  			</ul>
  		</div>
  	</section>
  	...
  	<section id="vision-mission" class="section-notch" style="background: #0a3d62; color: #fff;" data-aos="fade-up">
  		<div class="overlay padding-120">
  			<div class="container">
  				<div class="row">
  					<div class="col-md-6 col-sm-12" data-aos="fade-right" data-aos-delay="200">
  					...
  					<div class="col-md-6 col-sm-12" data-aos="fade-left" data-aos-delay="200">
  						<div style="background: rgba(255,255,255,0.1); padding: 40px; border-radius: 12px; text-align: center;">
  							<h3>Our Mission</h3>
  	...
  	<section class="achievements section-notch" data-aos="fade-up">
  		<div class="overlay padding-120">
  			<div class="container">
	  			<div class="row">
		            <div class="col-md-3 col-sm-6 col-xs-12" data-aos="zoom-in" data-aos-delay="100">
		            ...
		            <div class="col-md-3 col-sm-6 col-xs-12" data-aos="zoom-in" data-aos-delay="500">
		              <div class="achievement-item">
		            ...
		            <div class="col-md-3 col-sm-6 col-xs-12" data-aos="zoom-in" data-aos-delay="700">
		              <div class="achievement-item">
  	...
  	<!-- Gallery Section -->
  	<section id="gallery" class="gallery gallery-two section-bg padding-120" data-aos="fade-up">
  	...
  	<!-- Fees Section -->
  	<section class="pricing padding-120" data-aos="fade-up">
  		<div class="container">
	      <div class="section-header" data-aos="fade-down" data-aos-delay="100">
	      ...
	      <div class="row">
	      	<div class="col-md-4 col-sm-6 col-xs-12" data-aos="zoom-in" data-aos-delay="200">
	      	...
	      	<div class="col-md-4 col-sm-6 col-xs-12" data-aos="zoom-in" data-aos-delay="300">
	      		<div class="pricing-item">
	      			<div class="title">
	      				<h3>SSS 1 <span><sup>₦</sup></span></h3>
	      			</div>
	      			<div class="content">
	      	...
	      	<div class="col-md-4 col-sm-6 col-xs-12" data-aos="zoom-in" data-aos-delay="400">
	      		<div class="pricing-item">
	      			<div class="title">
	      				<h3>Boarding (Optional) <span><sup>₦</sup></span></h3>
	      			</div>
	      			<div class="content">
  	...
  	<!-- Contact Section -->
  	<section id="contact" class="padding-120 section-bg" data-aos="fade-up">
  		<div class="container">
  			<div class="section-header" data-aos="fade-down" data-aos-delay="100">
  			...
  			<div class="row text-center">
  				...
  				<div class="col-md-4 col-sm-12" data-aos="fade-up" data-aos-delay="400">
