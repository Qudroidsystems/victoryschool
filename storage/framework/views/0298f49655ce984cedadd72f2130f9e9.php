  		...
  		<div class="header-middle">
  			<div class="container">
  				<div class="row">
	  				...
	  				<div class="col-md-4 col-sm-4 col-xs-4">
	  					<a href="index-10.html" class="fm-logo"><img src="images/logo.png" alt="logo image" class="img-responsive"></a>
	  				</div>
	  				<div class="col-md-4 col-sm-4 col-xs-4">
  		...
  		<div class="main-menu">
			  ...
			  <div class="container">
			    ...
			    <div class="navbar-header">
					...
					<a class="navbar-brand" href="index-10.html"><img src="images/logo_02.png" alt="logo" class="img-responsive"></a>
			    </div>
					...
					<ul class="nav navbar-nav">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="index-10.html">Home Style 01</a></li>
  			...
  			<div class="container">
  				<div class="row">
	  				<div class="col-md-6 col-sm-6 col-xs-12">
	  					<p>&copy; 2024. Designer By <a href="https://themeforest.net/user/labartisan">LabArtisan</a></p>
	  				</div>
	  				<div class="col-md-6 col-sm-6 col-xs-12">
...
<?php /**PATH C:\xampp\htdocs\victoryschool\resources\views/website/home.blade.php ENDPATH**/ ?>